import generateLambdaCloudFormation from './cloudformation/lambda'
import generateDynamoDBCloudFormation from './cloudformation/dynamodb'
...
export default {
    Lambda: {
        ...
        generateCloudFormation: generateLambdaCloudFormation
    },
    DynamoDB: {
        type: 'DynamoDB',
        name: 'My Table',
    ...
    ApiGateway: {
        ...
        icon: () => (
            <svg width="48px" height="48px" viewBox="0 0 24 24" version="1.1">
                ...
                <g
                    id="Icon-Architecture/16/Arch_Amazon-API-Gateway_16"
                    stroke="none"
                    strokeWidth="1"
                    fill="none"
                    fillRule="evenodd"
                >
                    <g id="Rectangle" fill="url(#linearGradient-3)">
                        <rect x="0" y="0" width="24" height="24"></rect>
                    </g>
                    <g
                        id="Icon-Service/16/Amazon-API-Gateway_16"
                        transform="translate(4.000000, 4.000000)"
                        fill="#FFFFFF"
                    >
                        <path
                            d="M2,2.76751613 L4,1.43446738 L4,14.5659476 L2,13.2328988 L2,2.76751613 Z M1,2.49950633 L1,13.4999086 C1,13.6669147 1.084,13.8239204 1.223,13.9159238 L4.223,15.9159969 C4.307,15.971999 4.403,16 4.5,16 C4.581,16 4.662,15.9809993 4.736,15.9409978 C4.898,15.8539947 5,15.6849885 5,15.4999817 L5,12.9998903 L6,12.9998903 L6,11.9998537 L5,11.9998537 L5,3.99956118 L6,3.99956118 L6,2.99952461 L5,2.99952461 L5,0.499433192 C5,0.315426463 4.898,0.145420247 4.736,0.059417102 C4.574,-0.0275860794 4.377,-0.0185857503 4.223,0.0834179797 L1.223,2.08349112 C1.084,2.17649452 1,2.33250022 1,2.49950633 L1,2.49950633 Z M15,13.2328988 L13,14.5659476 L13,1.43446738 L15,2.76751613 L15,13.2328988 Z M15.777,2.08349112 L12.777,0.0834179797 C12.623,-0.0185857503 12.426,-0.0275860794 12.264,0.059417102 C12.102,0.145420247 12,0.315426463 12,0.499433192 L12,2.99952461 L11,2.99952461 L11,3.99956118 L12,3.99956118 L12,11.9998537 L11,11.9998537 L11,12.9998903 L12,12.9998903 L12,15.4999817 C12,15.6849885 12.102,15.8539947 12.264,15.9409978 C12.338,15.9809993 12.419,16 12.5,16 C12.597,16 12.693,15.971999 12.777,15.9159969 L15.777,13.9159238 C15.916,13.8239204 16,13.6669147 16,13.4999086 L16,2.49950633 C16,2.33250022 15.916,2.17649452 15.777,2.08349112 L15.777,2.08349112 Z M9,3.99956118 L10,3.99956118 L10,2.99952461 L9,2.99952461 L9,3.99956118 Z M7,3.99956118 L8,3.99956118 L8,2.99952461 L7,2.99952461 L7,3.99956118 Z M9,12.9998903 L10,12.9998903 L10,11.9998537 L9,11.9998537 L9,12.9998903 Z M7,12.9998903 L8,12.9998903 L8,11.9998537 L7,11.9998537 L7,12.9998903 Z M9.18,10.884813 L6.18,8.38472153 C6.065,8.28871802 6,8.1487129 6,7.99970745 C6,7.85170204 6.065,7.71069689 6.18,7.61569341 L9.18,5.11560199 L9.82,5.88463011 L7.281,7.99970745 L9.82,10.1157848 L9.18,10.884813 Z"
                            id="Amazon-API-Gateway_Icon_16_Squid"
                        ></path>
                    </g>
                </g>
            </svg>
        ),
        // TODO: implement generateCloudFormation for ApiGateway
    ...
    CognitoUserPool: {
        ...
        // TODO: implement generateCloudFormation for CognitoUserPool
        generateCloudFormation: () => {
            return {
                Resources: {},
                Outputs: {}
